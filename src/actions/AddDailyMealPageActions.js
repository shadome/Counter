...
//export function inputQuantity(x) { return {type:INPUT_QUANTITY, x}; }
//export function inputEnergyPct(x) { return {type:INPUT_ENERGY_PCT, x}; }
//export function inputFatPct(x) { return {type:INPUT_FAT_PCT, x}; }
//export function inputProteinPct(x) { return {type:INPUT_PROTEIN_PCT, x}; }
//export function inputEthanolPct(x) { return {type:INPUT_ETHANOL_PCT, x}; }
//export function inputCarbohydratesPct(x) { return {type:INPUT_CARBOHYDRATES_PCT, x}; }
//export function inputSaturatedFatPct(x) { return {type:INPUT_SATURATED_FAT_PCT, x}; }
//export function inputMonounsaturatedFatPct(x) { return {type:INPUT_MONOUNSATURATED_FAT_PCT, x}; }
//export function inputPolyunsaturatedFatPct(x) { return {type:INPUT_POLYUNSATURATED_FAT_PCT, x}; }
